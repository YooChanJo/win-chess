...
namespace WinChess {
    namespace ChessEngine {
        namespace Pieces {
            ...
            inline constexpr Pieces::PieceColor AllPieceColors[] = {
                Pieces::PieceColor::White,
                Pieces::PieceColor::Black
            };
            inline constexpr Pieces::PieceType AllPieceTypes[] = {
...
#define UNORDERED_MAP_WITH_PIECE(T) std::unordered_map<Pieces::PieceColor, std::unordered_map<Pieces::PieceType, T>>
        namespace Board {
            ...
            struct BoardDisplayProps {
                ...
                ImU32 EvenCellColor = IM_COL32(240, 217, 181, 255);
                ImU32 OddCellColor = IM_COL32(181, 136, 99, 255);
            };
        }
        ...
        private:            
            ...
            inline static int s_SourceIndex; // bit index of piece being being moved
        public:
